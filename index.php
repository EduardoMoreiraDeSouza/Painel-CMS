...
<header>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navcol-5">
				...
				<a class="btn border rounded-circle ms-md-2 btn-danger d-flex justify-content-center align-items-center" role="button" href="#" style="height: 38px;width: 42px;">
					<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-power">
	...
	<div class="container d-flex justify-content-center" style="width: 100%;">
		<div class="row d-flex align-items-end align-items-xl-end ms-0" style="width: 100%;padding: 15px;padding-bottom: 0px;">
			<div class="col-md-9">
			...
			<div class="col-md-3">
				<p class="d-flex flex-row align-items-center" style="font-size: 0.7em;">
					...
					</svg>&nbsp;Seu último login foi em: 12/12/2024
				</p>
			</div>
		</div>
	</div>
...
<section class="bred">
	<div class="container d-flex justify-content-center" style="width: 100%;margin-top: 20px;">
		<div class="row d-flex align-items-end align-items-xl-end ms-0" style="width: 100%;padding-right: 15px;padding-left: 15px;">
			<div class="col-md-9">
				<ol class="breadcrumb">
